...
# LeNet for Flowers using Keras and TensorFlow
...
def main():
    ...
    for i in range(10):
        ...
        # Train the model
        hist = lentnet.fit_generator( #history can later be used to get convergence rates
            training_set,
        ...
        # Evaluate the model
        (loss, accuracy) = lentnet.evaluate(
            validation_set,
